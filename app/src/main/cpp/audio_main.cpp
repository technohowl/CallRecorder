...
//com.aykuttasil.callrecorder.services
extern "C" {
JNIEXPORT void JNICALL
        Java_com_aykuttasil_callrecorder_services_RecordService_createSLEngine(JNIEnv *env, jclass, jint, jint);
JNIEXPORT void JNICALL
        Java_com_aykuttasil_callrecorder_services_RecordService_deleteSLEngine(JNIEnv *env, jclass type);
JNIEXPORT jboolean JNICALL
        Java_com_aykuttasil_callrecorder_services_RecordService_createSLBufferQueueAudioPlayer(JNIEnv *env, jclass);
JNIEXPORT void JNICALL
        Java_com_aykuttasil_callrecorder_services_RecordService_deleteSLBufferQueueAudioPlayer(JNIEnv *env, jclass type);

JNIEXPORT jboolean JNICALL
        Java_com_aykuttasil_callrecorder_services_RecordService_createAudioRecorder(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL
        Java_com_aykuttasil_callrecorder_services_RecordService_deleteAudioRecorder(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL
        Java_com_aykuttasil_callrecorder_services_RecordService_startPlay(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL
        Java_com_aykuttasil_callrecorder_services_RecordService_stopPlay(JNIEnv *env, jclass type);
}

JNIEXPORT void JNICALL
Java_com_aykuttasil_callrecorder_services_RecordService_createSLEngine(
...
JNIEXPORT jboolean JNICALL
Java_com_aykuttasil_callrecorder_services_RecordService_createSLBufferQueueAudioPlayer(JNIEnv *env, jclass type) {
