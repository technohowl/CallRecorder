...
import com.aykuttasil.callrecorder.receiver.CallRecordReceiver;
import com.aykuttasil.callrecorder.services.CallRecordService;
...
public class CallRecord {
    ...
    public static final String PREF_CALL_TYPE = "PrefCallType";
    public static final String PREF_NUM_RECORDS = "PrefTotalRecords";
    public static final String PREF_IS_RECORD_ENABLED = "PrefIsCallEnabled";
    public static final String PREF_IS_INCOMING_RECORD_ENABLED = "PrefIsInCallEnabled";
    public static final String PREF_IS_OUTGOING_RECORD_ENABLED = "PrefIsOutCallEnabled";
